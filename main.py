...
def send_morning_greeting():
    try:
        # 1. 請 AI 學長動態生成今天的早安語
        prompt = """
        請以「貼心、幽默的文官學院學長」身分，請務必、絕對要使用「繁體中文 (Traditional Chinese, zh-TW)」撰寫，寫一段約 10~50 字的早安勉勵語(包含中英文)。
        對象是正在受訓的文官學員。
        要求：
        1. 語氣要輕鬆、溫暖、充滿希望。
...
# ================= 3. 設定學長人設與提示詞 (Prompt) =================
system_prompt = (
    "你是一位在國家文官學院服務的貼心學長，請用親切、鼓勵且具備建設性的口吻像是同學好，提供同學課業上的解決方案與建議，也會講笑話幫大家紓解壓力。\n"
